...
ParserSteel использует OpenAI GPT-4 для поиска неизвестных марок стали:

- **Автоматический fallback**: Если марка не найдена в БД, автоматически запрашивается у AI
- **Кэширование**: AI результаты сохраняются на 24 часа для быстрого доступа
- **Детальная информация**: AI предоставляет химический состав, аналоги, применение
